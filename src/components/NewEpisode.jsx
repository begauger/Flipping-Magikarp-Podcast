...
export default function NewEpisode({ episode }) {
  ...
  return (
    <div className="flex-[2] relative flex justify-center items-center">
      ...
      <div className="bg-gradient-to-br from-blue-700 via-blue-400 to-orange-300 rounded-3xl shadow-2xl border-8 border-orange-300 p-12 flex flex-col items-center relative overflow-hidden z-20 min-w-[300px] max-w-2xl w-full scale-105 hover:scale-110 transition-transform duration-300">
        ...
        <div className="w-full flex flex-col items-center gap-8">
          <div className="flex-1 text-center">
            <h3 className="text-3xl font-bold text-blue-900 mb-2 text-center">{episode.title}</h3>
            <p className="text-blue-800 mb-4 text-lg text-center">{episode.description}</p>
            <span className="text-md text-orange-400 block text-center">{episode.date}</span>
          </div>
          {episode.audio && (
